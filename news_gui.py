...
class NewsApp:
    def __init__(self):
        ...
        self.data = requests.get(
            'https://newsapi.org/v2/top-headlines?country=in&apiKey=886f26cb19034ea3bab544f6ad27c62c').json()
        # initial GUI load
        self.load_gui()
    ...
    def load_gui(self):
        ...
        self.root.resizable(0,0) #prevents window size from resizing
    ...
    def load_news_item(self, index):
        ...
        try:
            ...
            img_url =  'https://i.stack.imgur.com/6M513.png'
            raw_data = urlopen(img_url).read()
            im = Image.open(io.BytesIO(raw_data)).resize((350, 250))
            photo = ImageTk.PhotoImage(im)
